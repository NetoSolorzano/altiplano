...
namespace TransCarga.ServiceConsultaCDR {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://service.sunat.gob.pe", ConfigurationName="ServiceConsultaCDR.billService")]
    public interface billService {
        ...
        TransCarga.ServiceConsultaCDR.getStatusCdrResponse getStatusCdr(TransCarga.ServiceConsultaCDR.getStatusCdrRequest request);
        ...
        TransCarga.ServiceConsultaCDR.getStatusResponse getStatus(TransCarga.ServiceConsultaCDR.getStatusRequest request);
    }
    ...
    public partial class getStatusCdrResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public TransCarga.ServiceConsultaCDR.statusResponse statusCdr;
        
        public getStatusCdrResponse() {
        }
        
        public getStatusCdrResponse(TransCarga.ServiceConsultaCDR.statusResponse statusCdr) {
    ...
    public partial class getStatusResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://service.sunat.gob.pe", Order=0)]
        [System.Xml.Serialization.XmlElementAttribute(Form=System.Xml.Schema.XmlSchemaForm.Unqualified)]
        public TransCarga.ServiceConsultaCDR.statusResponse status;
        
        public getStatusResponse() {
        }
        
        public getStatusResponse(TransCarga.ServiceConsultaCDR.statusResponse status) {
            this.status = status;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface billServiceChannel : TransCarga.ServiceConsultaCDR.billService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class billServiceClient : System.ServiceModel.ClientBase<TransCarga.ServiceConsultaCDR.billService>, TransCarga.ServiceConsultaCDR.billService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TransCarga.ServiceConsultaCDR.getStatusCdrResponse TransCarga.ServiceConsultaCDR.billService.getStatusCdr(TransCarga.ServiceConsultaCDR.getStatusCdrRequest request) {
            return base.Channel.getStatusCdr(request);
        }
        
        public TransCarga.ServiceConsultaCDR.statusResponse getStatusCdr(string rucComprobante, string tipoComprobante, string serieComprobante, int numeroComprobante) {
            TransCarga.ServiceConsultaCDR.getStatusCdrRequest inValue = new TransCarga.ServiceConsultaCDR.getStatusCdrRequest();
            ...
            TransCarga.ServiceConsultaCDR.getStatusCdrResponse retVal = ((TransCarga.ServiceConsultaCDR.billService)(this)).getStatusCdr(inValue);
            return retVal.statusCdr;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TransCarga.ServiceConsultaCDR.getStatusResponse TransCarga.ServiceConsultaCDR.billService.getStatus(TransCarga.ServiceConsultaCDR.getStatusRequest request) {
            return base.Channel.getStatus(request);
        }
        
        public TransCarga.ServiceConsultaCDR.statusResponse getStatus(string rucComprobante, string tipoComprobante, string serieComprobante, int numeroComprobante) {
            TransCarga.ServiceConsultaCDR.getStatusRequest inValue = new TransCarga.ServiceConsultaCDR.getStatusRequest();
            inValue.rucComprobante = rucComprobante;
            inValue.tipoComprobante = tipoComprobante;
            inValue.serieComprobante = serieComprobante;
            inValue.numeroComprobante = numeroComprobante;
            TransCarga.ServiceConsultaCDR.getStatusResponse retVal = ((TransCarga.ServiceConsultaCDR.billService)(this)).getStatus(inValue);
